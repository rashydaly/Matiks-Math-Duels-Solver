🧩 Matiks Solver v2.0
An intelligent, high-performance Chrome Extension designed as a helper and automated solver tool for the Matiks web application.

🚀 About the Extension
Matiks Solver v2.0 is an upgraded browser extension built to assist users interacting with the Matiks web app. It automates problem-solving workflows, extracts on-screen data seamlessly using advanced OCR (Optical Character Recognition), and now features an Automate Button with custom question limits and configurable time delays alongside a completely revamped, modern UI.

✨ What's New in v2.0?
Improved UI (v2.0): A sleek, modern, and dark-themed popup interface (popup.html, popup.css) built for better user experience and ease of control.

Automate Button with Limits & Time Delays: Introduced a dedicated automation panel where users can set a specific question limit (e.g., 25 questions) and configure a custom time delay between each question to ensure smooth execution without overwhelming the web app.

🛠️ Tech Stack & Technologies Used
JavaScript (ES6+): Core extension logic, background scripts, and DOM manipulation.

HTML5 / CSS3: Modernized user interface design for the extension popup (popup.html, popup.css).
